...
.delta{background:#fffaf0;border:1px solid #f0e2c8;border-left:4px solid var(--amb);border-radius:10px;padding:12px 16px;margin:0 0 20px;font-size:12.5px;color:#5c5230}
.delta b{color:#0d1b2a}
.plan{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin:4px 0 14px}
.phase{background:#f8fafb;border:1px solid var(--line);border-radius:10px;padding:14px}
.phase .ph{font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.4px;color:var(--pr)}
.phase .pt{font-size:13.5px;color:#33424f;margin-top:6px}
.metric{background:#0d1b2a;color:#eaf1f7;border-radius:10px;padding:14px 18px;font-size:13.5px}
.metric b{color:#fff}.metric .star{color:var(--amb);font-weight:700;text-transform:uppercase;letter-spacing:.4px;font-size:11px}
@media(max-width:760px){.kpis{grid-template-columns:repeat(2,1fr)}.grid{grid-template-columns:1fr}.plan{grid-template-columns:1fr}}
</style></head>
<body><div class="wrap">
<header>
